...
| BigBlueButton-serverhost | Dit is de naam van de server waarop uw BigBlueButton-server draait. Dit kan _localhost zijn_ , een IP-adres \(bijv. 192.168.13.54\) of een domeinnaam \(bijv. Mijn.video.com\). |  |
