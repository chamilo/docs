## Assessments pre-configuration {#assessments-pre-configuration}
...
To view and edit this basic configuration , click on any of the edit icons ( <img src="../assets/graphics182.svg" width="32px" />) of the page:
