## Administrer les « Utilisateurs » {#administrer-les-utilisateurs}
...
### Rôles utilisateurs {#r-les-utilisateurs}
...
![](../assets/graficos80.png)Illustration 43: Rôles et sessions
...
![](../assets/image35.png)Illustration 44: Rôles disponibles à la création d&#039;un utilisateur
...
#### L&#039;apprenant (ou étudiant) {#l-apprenant-ou-tudiant}
...
#### L&#039;assistant de cours {#l-assistant-de-cours}
...
#### Le responsable des ressources humaines (ou Supervision) {#le-responsable-des-ressources-humaines-ou-supervision}
...
#### Le tuteur (ou coach) {#le-tuteur-ou-coach}
...
#### Le tuteur de session (ou coach de session) {#le-tuteur-de-session-ou-coach-de-session}
...
#### L&#039;enseignant (ou prof) {#l-enseignant-ou-prof}
...
#### L&#039;administrateur de session {#l-administrateur-de-session}
...
#### L&#039;administrateur de portail {#l-administrateur-de-portail}
...
#### L&#039;administrateur global {#l-administrateur-global}
...
#### Le supérieur d&#039;apprenant {#le-sup-rieur-d-apprenant}
...
#### Cas particulier: L&#039;utilisateur anonyme {#cas-particulier-l-utilisateur-anonyme}
...
![](../assets/graficos25.png)Illustration 46: Administration - liste d&#039;utilisateurs
...
![](../assets/graficos44.png)Illustration 47: Administration - Utilisateurs - Options par rôles
...
![](../assets/graficos79.png)Illustration 48: Administration - Formulaire de création d&#039;utilisateur
...
![](../assets/exporterliste_-utilisateurs.png)Illustration 49: Administration - Export d&#039;utilisateurs
...
### Importer une liste d&#039;utilisateurs au format XML/CSV {#importer-une-liste-d-utilisateurs-au-format-xml-csv}
...
![](../assets/importerliste_-utilisateurs.png)Illustration 50: Administration - Import d&#039;utilisateurs
...
![](../assets/importerliste_-utilisateurs2.png)Illustration 51: Administration - Rapport d&#039;import utilisateurs
...
![](../assets/profil.png)Illustration 52: Administration - Liste des champs utilisateurs
...
![](../assets/image27.png)Illustration 53: Types de champs extra
...
#### Liste des classes {#liste-des-classes}
...
![](../assets/groupeliste.png)Illustration 54: Administration - Liste des classes et groupes sociaux
...
![](../assets/groupesajouter.png)Illustration 55: Administration - Création de groupes sociaux
