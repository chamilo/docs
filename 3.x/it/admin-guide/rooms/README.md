...
## Accesso al blocco Aule

Dal pannello di amministrazione, il blocco **Aule** compare accanto agli altri blocchi della dashboard. Fare clic su uno qualsiasi dei suoi collegamenti per aprire lo strumento corrispondente.

## Contenuto del blocco

* **[Gestione delle aule](managing-rooms.md)** — Creare e organizzare le filiali (siti) e le aule all'interno di ciascuna
* **[Ricerca disponibilità aule](room-availability-finder.md)** — Verificare quali aule sono libere per un dato intervallo di data e ora

## Nota sul multi-URL

In un'installazione multi-URL (multi-tenant), filiali e aule sono circoscritte a un singolo URL di accesso ciascuna — non vengono mai condivise tra i portali.