...
Agendaverktøyet lar deg planlegge hendelser og frister i kurset ditt. Hendelsene vises i en kalender som studentene kan se.
...
* **Personlige hendelser** — Filtrer for å se bare hendelser som er relevante for deg
...
2. Fyll inn hendelsesdetaljene:
   ...
   * **Startdato og -tid**
   * **Sluttdato og -tid**
   * **Beskrivelse** — Ytterligere detaljer (støtter rik tekst)
3. Velg **målgruppe**:
...
Du har også en **personlig agenda** tilgjengelig fra sidemenyen. Den personlige agendaen samler hendelser fra alle kursene dine i én visning. Det er her studentene ser den samlede timeplanen for alle kursene de er påmeldt.

## Tips

* **Sett frister** — Opprett hendelser for innleveringsfrister og øvelsesfrister slik at studentene kan se dem i kalenderen
* **Bruk påminnelser** — Aktiver e-postpåminnelser for viktige hendelser for å hjelpe studentene med å holde tritt
* **Koordiner med økter** — Hvis du underviser i flere økter, har hver økt sine egne hendelser, synlige bare for studentene i den økten. Lærere har en funksjon for å se hendelsene (hjemmearbeid, utflukter osv.) i andre kurs i øktene sine for å unngå å overbelaste studentene.