...
Bruk **Slett varsel på kurshjemmesiden** for å fjerne det.

## Tips

* **Bare ett varsel per kurs** — Å opprette et nytt erstatter det som var der fra før; det er ikke mulig å kølegge flere
* **Forhåndsvis formateringen** — Varselet vises som rå HTML i et sprettoppvindu, så sjekk at rik tekst vises slik du forventer før du publiserer det
* **Bruk utløpslenken for alt som er tidssensitivt** — Uten den fortsetter det samme varselet å dukke opp i det uendelige, noe som kan bli gjentakende for studenter som kommer tilbake