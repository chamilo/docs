...
作为教师，此处无需进行任何配置。管理员会在 **管理 > LTI 1.3 Advantage Provider** 中完全负责登记哪些测验或学习路径可通过此方式启动，以及可由哪些外部平台启动。

如果您的平台启用了此插件，这只意味着部分学生可能通过点击其他系统中的链接来访问您的某次测验或学习路径，而不是直接登录 Chamilo——参加测验或学习路径本身的体验不会改变。

## 提示

* **如有疑问，请询问管理员** — 如果您想了解自己的内容是否以这种方式对外提供，管理员可以告知您哪些活动已登记