...
## Zugriff auf den Block Räume

Im Administrationsbereich erscheint der Block **Räume** neben den anderen Dashboard-Blöcken. Klicken Sie auf einen der Links, um das entsprechende Werkzeug zu öffnen.

## Inhalt des Blocks

* **[Räume verwalten](managing-rooms.md)** — Niederlassungen (Standorte) und die Räume in jeder Niederlassung anlegen und organisieren
* **[Raumsuche nach Verfügbarkeit](room-availability-finder.md)** — Prüfen, welche Räume für ein bestimmtes Datum und einen bestimmten Zeitraum frei sind

## Hinweis zu Multi-URL

Bei einer Multi-URL-Installation (Multi-Tenant) sind Niederlassungen und Räume jeweils auf eine einzelne Zugriffs-URL beschränkt — sie werden niemals über Portale hinweg geteilt.