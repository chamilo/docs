...
Die Kursstartseite ist die erste Seite, die Ihre Lernenden sehen, wenn sie einen Kurs betreten. Diese Seite beschreibt, wie Sie sie anpassen, um einen ansprechenden Einstiegspunkt zu schaffen.

## Kurseinführung

Die Kurseinführung ist ein Rich-Text-Bereich, der oben auf der Startseite über dem Werkzeugraster angezeigt wird. Nutzen Sie ihn, um:

* Ihre Lernenden willkommen zu heißen
* die Kursziele zu beschreiben
* Anweisungen für den Einstieg bereitzustellen
...
Wenn noch keine Einführung erstellt wurde, sehen Sie eine Schaltfläche zum **Erstellen einer Einführung**.
...
* einem Symbol, das das Werkzeug darstellt
* dem Werkzeugnamen

Die in Ihrem Kurs verfügbaren Werkzeuge können umfassen:
...
Eine bemerkenswerte Änderung gegenüber Chamilo 1.* besteht darin, dass die Werkzeuge nicht mehr in 3 verschiedene Abschnitte unterteilt werden. Dadurch haben Lehrende die volle Kontrolle darüber, welche Werkzeuge in welcher Reihenfolge angezeigt werden.

Außerdem wurden die Werkzeuge **Tracking** und **Wartung** an den oberen Rand der Seite unter die Statistik- und Zahnradsymbole verschoben, um Werkzeuge, die Lernenden nie angezeigt werden, aus der Liste zu entfernen.

## Werkzeuge organisieren

### Neu anordnen

1. Klicken Sie oben im Werkzeugraster auf die Schaltfläche **Sortieren**
2. Ziehen Sie Werkzeuge per Drag-and-Drop, um ihre Reihenfolge zu ändern
3. Die neue Reihenfolge wird automatisch gespeichert

### Ausblenden und Anzeigen

* Klicken Sie auf das **Sichtbarkeitssymbol** eines beliebigen Werkzeugs, um es für Lernende zwischen sichtbar und ausgeblendet umzuschalten
...
Sie können bestimmte Werkzeuge so konfigurieren, dass sie automatisch starten, wenn ein Lernender den Kurs betritt. Ist dies aktiviert, erscheint oben auf der Kursstartseite eine Benachrichtigung, welches Auto-Launch aktiv ist:

* Dokument-Auto-Launch — Öffnet automatisch ein bestimmtes Dokument
* Übungs-Auto-Launch — Startet sofort einen Test
* Lernpfad-Auto-Launch — Startet beim Kurseintritt einen Lernpfad
* Forum-Auto-Launch — Öffnet das Forum direkt