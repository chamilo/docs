...
If you teach within a session, reports are scoped to the session's learners. Session tutors have access to reports across all courses in their session. A global configuration setting can also allows teachers to see assignments through all sessions using their course (ask your admin).
