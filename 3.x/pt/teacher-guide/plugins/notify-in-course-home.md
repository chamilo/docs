...
Utilize **Eliminar notificação na página inicial do curso** para a remover.

## Sugestões

* **Apenas um aviso por curso** — Criar um novo substitui o que existia anteriormente; não é possível colocar vários em fila
* **Pré-visualize a formatação** — O aviso é apresentado como HTML em bruto numa janela popup, por isso verifique se o texto formatado é apresentado como espera antes de o publicar
* **Utilize a ligação de expiração para tudo o que for sensível ao tempo** — Sem ela, o mesmo aviso continua a surgir indefinidamente, o que pode tornar-se repetitivo para os formandos que regressam