...
A ferramenta de agenda permite-lhe agendar eventos e prazos no seu curso. Os eventos aparecem num calendário que os seus formandos podem consultar.
...
* **Eventos pessoais** — Filtrar para ver apenas os eventos relevantes para si
...
2. Preencha os detalhes do evento:
   ...
   * **Data e hora de fim**
   * **Descrição** — Detalhes adicionais (suporta texto formatado)
3. Escolha o **público**:
...
Tem também uma **agenda pessoal** acessível a partir da barra lateral. A agenda pessoal agrega os eventos de todos os seus cursos numa única vista. É aqui que os formandos veem o seu horário combinado em todos os cursos em que estão inscritos.

## Dicas

* **Definir prazos** — Crie eventos para as datas de entrega de trabalhos e os prazos de exercícios para que os formandos os possam ver no calendário
* **Utilizar lembretes** — Ative lembretes por e-mail para eventos importantes, para ajudar os formandos a manterem-se em dia
* **Coordenar com sessões** — Se lecionar em várias sessões, cada sessão tem os seus próprios eventos, visíveis apenas para os formandos dessa sessão. Os professores dispõem de uma funcionalidade para ver os eventos (trabalhos de casa, excursões, etc.) de outros cursos nas suas sessões, de forma a evitar sobrecarregar os estudantes.