...
Esta secção explica como criar um novo curso no Chamilo e configurá-lo de acordo com as suas necessidades.
...
|-------|----------|-------------|
| **Nome do curso** | Sim | Um título curto e descritivo para o seu curso (p. ex., "Gestão da Inovação") |
| **Categoria do curso** | Não | Selecione uma categoria para ajudar a organizar os cursos na plataforma |
| **Código do curso** | Não | Um código curto que utiliza apenas letras e números (máx. 40 caracteres). Se for deixado em branco, é gerado automaticamente a partir do nome do curso |
| **Idioma** | Não | O idioma principal do curso. Por predefinição, corresponde ao seu idioma atual |

Se estiver ativado, poderá também encontrar uma definição de **Sala predefinida** e a possibilidade de utilizar um **Modelo de curso** para evitar criar o curso totalmente do zero.

4. Clique em **Criar este curso**

Será redirecionado para a página inicial do seu novo curso. Aparecerá uma mensagem de confirmação: "Curso criado com sucesso."
...
Clique no botão **Vista de estudante** para ver a página inicial do curso exatamente como um formando a veria. Isto é útil para verificar que as ferramentas ocultas e o conteúdo não publicado não estão visíveis. Clique novamente no botão para regressar à vista de professor.

## Próximos Passos

* [Definições do Curso](course-settings.md) — Configurar o acesso, a inscrição e outras opções ao nível do curso
* [Página Inicial do Curso](course-homepage.md) — Guia detalhado para personalizar a página inicial do seu curso
* [Descrição do Curso](course-description.md) — Redigir uma descrição estruturada do seu curso para o catálogo de cursos