...
O seguinte descreve o stack tecnológico do Chamilo 3.0. Todas as versões indicadas aqui estão sujeitas a alteração à medida que novas versões do Chamilo forem lançadas. Os números de versão utilizam a [notação de versões do Composer](https://getcomposer.org/doc/articles/versions.md), que define regras para permitir alguma flexibilidade em torno das versões.

Incluindo dependências hierárquicas, o Chamilo utiliza várias centenas de bibliotecas de Software Livre. Esta lista inclui apenas aquelas que mais utilizamos e que provavelmente afetarão o trabalho de um programador Chamilo todas as semanas ou quase. Estamos gratos a todos os outros programadores de Software Livre que tornam o nosso trabalho mais fácil, mais sustentável e mais seguro.
...
Através de adaptadores Flysystem:

* Sistema de ficheiros local (predefinição)
