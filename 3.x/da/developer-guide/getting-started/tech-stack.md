...
Følgende beskriver teknologistakken for Chamilo 3.0. Alle versioner angivet her vil sandsynligvis ændre sig, efterhånden som nye versioner af Chamilo udgives. Versionsnumre bruger [Composers versionsnotation](https://getcomposer.org/doc/articles/versions.md), som fastsætter regler, der giver en vis fleksibilitet omkring versioner.

Inklusive hierarkiske afhængigheder anvender Chamilo flere hundrede Free Software-biblioteker. Denne liste omfatter kun dem, vi bruger mest, og som sandsynligvis vil påvirke en Chamilo-udviklers arbejde hver uge eller deromkring. Vi er taknemmelige over for alle andre Free Software-udviklere derude, som gør vores arbejde lettere, mere vedligeholdeligt og mere sikkert.
