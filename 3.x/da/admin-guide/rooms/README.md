...
## Adgang til blokken Lokaler

Fra administrationspanelet vises blokken **Lokaler** sammen med de øvrige dashboardblokke. Klik på et af dens links for at åbne det tilsvarende værktøj.

## Indholdet af blokken

* **[Administration af lokaler](managing-rooms.md)** — Opret og organisér afdelinger (sites) og lokalerne i hver af dem
* **[Find ledighed for lokaler](room-availability-finder.md)** — Tjek, hvilke lokaler der er ledige for et givet dato- og tidsinterval

## Bemærkning om multi-URL

På en multi-URL-installation (multi-tenant) er afdelinger og lokaler knyttet til hver sin adgangs-URL — de deles aldrig på tværs af portaler.