...
La herramienta de glosario le permite definir términos clave para su curso. Los alumnos pueden consultar el glosario para buscar definiciones mientras estudian.
...
El glosario puede mostrarse en dos formatos, que se conmutan desde la barra de herramientas:
...
* **Constrúyalo de forma progresiva** — Añada términos a medida que los introduce en su curso, en lugar de todos a la vez
* **Mantenga las definiciones concisas** — Las definiciones breves y claras son más útiles que las explicaciones extensas
* **Enlace desde las rutas de aprendizaje** — Haga referencia a términos del glosario desde el contenido de su ruta de aprendizaje para animar a los alumnos a utilizar el glosario