...
Utilice **Eliminar notificación en la página de inicio del curso** para quitarla.

## Consejos

* **Solo un aviso por curso** — Al crear uno nuevo se sustituye el que hubiera antes; no hay forma de poner varios en cola
* **Previsualice el formato** — El aviso se muestra como HTML sin procesar en una ventana emergente, así que compruebe que el texto enriquecido se renderiza como espera antes de publicarlo
* **Use el enlace de caducidad para todo lo que sea sensible al tiempo** — Sin él, el mismo aviso sigue apareciendo indefinidamente, lo que puede resultar repetitivo para los alumnos que vuelven