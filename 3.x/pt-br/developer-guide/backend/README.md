...
* **[Controllers](controllers.md)** — Organização de controllers e padrões de roteamento
* **[Eventos e Listeners](events-and-listeners.md)** — Como o Chamilo utiliza o sistema de eventos do Symfony
* **[Sistema de Configurações](settings-system.md)** — Os schemas de configurações em `src/CoreBundle/Settings/` e como funciona a configuração da plataforma