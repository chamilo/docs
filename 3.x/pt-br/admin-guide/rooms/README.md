...
## Acessando o Bloco Salas

No painel de administração, o bloco **Salas** aparece ao lado dos demais blocos do painel. Clique em qualquer um de seus links para abrir a ferramenta correspondente.

## O Que Há no Bloco

* **[Gerenciando Salas](managing-rooms.md)** — Criar e organizar filiais (unidades) e as salas dentro de cada uma
* **[Localizador de Disponibilidade de Salas](room-availability-finder.md)** — Verificar quais salas estão livres para uma determinada data e intervalo de horário

## Nota sobre Multi-URL

Em uma instalação multi-URL (multi-tenant), filiais e salas são delimitadas a uma única URL de acesso cada — nunca são compartilhadas entre portais.