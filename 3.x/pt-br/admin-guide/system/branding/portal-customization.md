...
* **Logotipo da plataforma** — Envie o logotipo da sua organização (exibido na barra superior)

## Dicas

* **Mantenha a página inicial limpa** — Conteúdo em excesso na página inicial pode ser sobrecarregante. Concentre-se em anúncios essenciais e no acesso aos cursos.
* **Atualize regularmente** — Mantenha os anúncios do sistema atualizados e remova os desatualizados
* **Envie um logotipo de alta qualidade** — O logotipo é um dos elementos de identidade visual mais visíveis. Use uma imagem nítida e com tamanho adequado.