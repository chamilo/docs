...
Det här avsnittet förklarar hur du skapar en ny kurs i Chamilo och konfigurerar den efter dina behov.
...
|-------|----------|-------------|
| **Kursnamn** | Ja | En kort, beskrivande titel för din kurs (t.ex. "Innovationsledning") |
| **Kurskategori** | Nej | Välj en kategori för att hjälpa till att organisera kurser på plattformen |
| **Kurskod** | Nej | En kort kod som endast består av bokstäver och siffror (max 40 tecken). Om fältet lämnas tomt genereras en kod automatiskt utifrån kursnamnet |
| **Språk** | Nej | Kursens primära språk. Standardvärdet är ditt aktuella språk |

Om funktionen är aktiverad kan du även hitta inställningen **Standardrum** och möjligheten att använda en **Kursmall** så att du inte behöver skapa kursen helt från grunden.

4. Klicka på **Skapa den här kursen**

Du omdirigeras till startsidan för din nya kurs. Ett bekräftelsemeddelande visas: "Kursen har skapats."
...
Klicka på knappen **Studentvy** för att se kursens startsida exakt som en deltagare skulle se den. Det är användbart för att kontrollera att dolda verktyg och opublicerat innehåll inte är synliga. Klicka på knappen igen för att återgå till lärarvyn.

## Nästa steg

* [Kursinställningar](course-settings.md) — Konfigurera åtkomst, registrering och andra kursövergripande alternativ
* [Kursens startsida](course-homepage.md) — Detaljerad guide för att anpassa kursens startsida
* [Kursbeskrivning](course-description.md) — Skriv en strukturerad beskrivning av din kurs för kurskatalogen