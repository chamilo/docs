...
Verktyget Agenda låter dig schemalägga händelser och tidsfrister i din kurs. Händelser visas i en kalender som dina deltagare kan se.
...
* **Personliga händelser** — Filtrera för att bara se händelser som är relevanta för dig
...
2. Fyll i händelsens uppgifter:
   ...
   * **Startdatum och tid**
   * **Slutdatum och tid**
   * **Beskrivning** — Ytterligare detaljer (stöder rich text)
3. Välj **målgrupp**:
...
Du har också en **personlig agenda** som nås från sidofältet. Den personliga agendan samlar händelser från alla dina kurser i en enda vy. Det är här deltagare ser sitt samlade schema för alla kurser de är inskrivna i.

## Tips

* **Ange tidsfrister** — Skapa händelser för inlämningsdatum för uppgifter och tidsfrister för övningar så att deltagarna kan se dem i sin kalender
* **Använd påminnelser** — Aktivera e-postpåminnelser för viktiga händelser för att hjälpa deltagarna att hålla sig på rätt spår
* **Samordna med sessioner** — Om du undervisar i flera sessioner har varje session sina egna händelser, synliga endast för den sessionens deltagare. Lärare har en funktion för att se händelser (läxor, utflykter osv.) från andra kurser i sina sessioner för att undvika att överbelasta studenterna.