...
Följande beskriver teknikstacken för Chamilo 3.0. Alla versioner som anges här kommer sannolikt att ändras när nya versioner av Chamilo släpps. Versionsnummer använder [Composers versionsnotation](https://getcomposer.org/doc/articles/versions.md) som sätter regler för att tillåta viss flexibilitet kring versioner.

Inklusive hierarkiska beroenden använder Chamilo flera hundra bibliotek med fri programvara. Denna lista omfattar endast de vi använder mest och som sannolikt påverkar en Chamilo-utvecklares arbete varje vecka eller så. Vi är tacksamma mot alla andra utvecklare av fri programvara där ute som gör vårt arbete enklare, mer underhållbart och mer säkert.
