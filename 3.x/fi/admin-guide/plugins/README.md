...
Lisäosat laajentavat Chamilon toiminnallisuutta muuttamatta ydinohjelmistoa. Chamilo 3.0 sisältää yli 50 lisäosaa, jotka voidaan aktivoida tarpeen mukaan.
...
* **[Lisäosien hallinta](managing-plugins.md)** — Asenna, aktivoi, määritä ja poista käytöstä lisäosia