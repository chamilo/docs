...
3. 填寫詳細資料：
   ...
   * **說明** — 選填，說明此資源的內容
   * **類別** — 將連結指派至類別以便整理
   * **目標** — 連結開啟位置：`_self`（同一視窗）、`_blank`（新分頁）、`_parent` 或 `_top`
   * **在課程首頁顯示連結** — 是否要以工具圖示顯示於課程首頁
4. 儲存
...
您可將連結集合匯出為 PDF。請在連結工具中尋找 **匯出** 選項。

## 小提示

* **依主題分類** — 為課程的每個單元或每週建立一個類別
* **加上說明** — 協助學習者在點選前了解該連結為何相關
* **定期檢查** — 網頁連結可能隨時間過時或失效