...
Sélectionnez « Oui » pour activer cette fonctionnalité. Elle dépend fortement de l’extension Xapian pour PHP, elle ne fonctionnera donc pas si cette extension n’est pas installée sur votre serveur, en version 1.x au minimum.
...
Lors de l’affichage des résultats d’une recherche en texte intégral, que faut-il faire des résultats qui ne sont pas accessibles à l’utilisateur actuel ?
