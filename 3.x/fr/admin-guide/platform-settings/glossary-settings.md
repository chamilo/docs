...
Choisissez la vue ('table' ou 'list') qui sera utilisée par défaut dans l'outil glossaire.
...
À partir d'ici, vous pouvez configurer la manière d'ajouter les termes du glossaire dans des outils supplémentaires tels que le parcours d'apprentissage et l'outil d'exercice