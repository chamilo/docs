...
Comportement du catalogue de cours (la liste publique où les utilisateurs peuvent parcourir les cours et s’y inscrire eux-mêmes).
...
Activer l’inscription automatique des utilisateurs aux sessions.
...
Rendre le catalogue de cours disponible aux utilisateurs anonymes (le grand public) sans nécessité de se connecter.
...
Configuration JSON du catalogue de cours : paramètres de liens, filtres, options de tri, et plus encore.

### `course_subscription_in_user_s_session`

**Inscription dans la vue session**
...
Retirer le lien d’URL publique des cartes de cours.

*Par défaut : `false`*

### `only_show_course_from_selected_category`

**N’afficher que les catégories correspondantes dans le catalogue de cours**

Lorsqu’il n’est pas vide, seuls les cours des catégories indiquées apparaîtront dans le catalogue de cours.

### `only_show_selected_courses`

**Uniquement les cours sélectionnés**

N’afficher dans le catalogue que les cours sélectionnés manuellement.
...
Configuration JSON du catalogue de sessions : filtres et options d’affichage.

### `show_courses_descriptions_in_catalog`

**Afficher les descriptions de cours**

Afficher les descriptions de cours dans la liste du catalogue.
