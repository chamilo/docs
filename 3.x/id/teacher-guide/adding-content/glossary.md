...
Alat glosarium memungkinkan Anda mendefinisikan istilah-istilah kunci untuk kursus Anda. Pembelajar dapat menelusuri glosarium untuk mencari definisi saat belajar.
...
Glosarium dapat ditampilkan dalam dua format, yang dialihkan dari bilah alat:

* **Table view** — Istilah tercantum dalam tabel beserta definisinya
* **List view** — Istilah ditampilkan sebagai panel terpisah yang disusun bertumpuk satu demi satu

## Tips

* **Bangun secara bertahap** — Tambahkan istilah seiring Anda memperkenalkannya dalam kursus, bukan sekaligus
* **Jaga definisi tetap ringkas** — Definisi yang singkat dan jelas lebih bermanfaat daripada penjelasan yang panjang
* **Tautkan dari learning path** — Rujuk istilah glosarium dari konten learning path Anda untuk mendorong pembelajar menggunakan glosarium