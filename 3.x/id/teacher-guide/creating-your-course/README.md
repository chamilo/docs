...
Bagian ini menjelaskan cara membuat kursus baru di Chamilo dan mengonfigurasinya sesuai kebutuhan Anda.
...
|-------|----------|-------------|
| **Nama kursus** | Ya | Judul singkat dan deskriptif untuk kursus Anda (misalnya, "Manajemen Inovasi") |
| **Kategori kursus** | Tidak | Pilih kategori untuk membantu mengorganisasi kursus di platform |
| **Kode kursus** | Tidak | Kode singkat yang hanya menggunakan huruf dan angka (maks. 40 karakter). Jika dikosongkan, kode akan dibuat secara otomatis dari nama kursus |
| **Bahasa** | Tidak | Bahasa utama kursus. Secara default mengikuti bahasa Anda saat ini |

Jika diaktifkan, Anda mungkin juga menemukan pengaturan **Ruang default** dan kemungkinan menggunakan **Templat kursus** agar tidak perlu membuat kursus sepenuhnya dari awal.

4. Klik **Buat kursus ini**

Anda akan diarahkan ke beranda kursus baru Anda. Pesan konfirmasi akan muncul: "Kursus berhasil dibuat."
...
Klik tombol **Tampilan siswa** untuk melihat beranda kursus persis seperti yang dilihat peserta didik. Ini berguna untuk memverifikasi bahwa alat tersembunyi dan konten yang belum dipublikasikan tidak terlihat. Klik tombol tersebut lagi untuk kembali ke tampilan pengajar.

## Langkah Selanjutnya

* [Pengaturan Kursus](course-settings.md) — Konfigurasikan akses, pendaftaran, dan opsi tingkat kursus lainnya
* [Beranda Kursus](course-homepage.md) — Panduan terperinci untuk menyesuaikan beranda kursus Anda
* [Deskripsi Kursus](course-description.md) — Tulis deskripsi terstruktur tentang kursus Anda untuk katalog kursus