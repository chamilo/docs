...
## Mengakses Blok Rooms

Dari panel administrasi, blok **Rooms** muncul bersama blok dasbor lainnya. Klik salah satu tautannya untuk membuka alat yang sesuai.

## Isi Blok

* **[Mengelola Ruangan](managing-rooms.md)** — Membuat dan mengatur cabang (situs), serta ruangan di dalam masing-masing cabang
* **[Pencari Ketersediaan Ruangan](room-availability-finder.md)** — Memeriksa ruangan mana yang kosong untuk rentang tanggal dan waktu tertentu

## Catatan Multi-URL

Pada instalasi multi-URL (multi-tenant), cabang dan ruangan dicakup ke satu URL akses masing-masing — tidak pernah dibagikan antar portal.