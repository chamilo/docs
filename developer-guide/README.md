...
Welcome to the Chamilo 3.0 Developer Guide. This guide is for developers who want to understand the Chamilo architecture, extend the platform with plugins, use the API, customize the interface, or contribute to the project.

## Architecture at a Glance

Chamilo 3.0 is built on:

* **Backend**: Symfony 7.4 (PHP 8.3–8.5) with Doctrine ORM and API Platform 4
