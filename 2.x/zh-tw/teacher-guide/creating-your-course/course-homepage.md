...
課程首頁是學習者進入課程時首先看到的頁面。本頁面說明如何自訂課程首頁，以建立吸引人的進入點。

## 課程介紹

課程介紹是位於首頁上部、工具格上方顯示的富文本區域。請用於以下目的：
...
Chamilo 1.* 的顯著變更之一，是不再將工具分割成三個不同區段。這讓教師能完全控制顯示哪些工具及順序。

此外，**追蹤** 及 **維護** 工具已移至頁面頂部統計資料與齒輪圖示下方，以從清單中移除永不顯示給學習者的工具。
...
您可以設定特定工具在學習者進入課程時自動啟動。啟用後，課程首頁上方會顯示通知，指示哪些自動啟動已啟用：
