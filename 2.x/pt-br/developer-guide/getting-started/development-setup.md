...
O repositório inclui o arquivo `.env.dist` como referência. Crie um arquivo `.env` vazio que o instalador web irá preencher — mantê-lo vazio garante que atualizações nunca sobrescrevam sua configuração local:
