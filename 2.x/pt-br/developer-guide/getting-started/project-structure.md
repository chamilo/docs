...
│   ├── lp/              # Componentes de trilha de aprendizado
...
│   ├── platform/        # Componentes de interface no nível da plataforma
│   ├── resource_links/  # Componentes de gerenciamento de links de recursos
│   ├── room/            # Componentes de sala virtual
│   ├── session/         # Componentes de sessão (campanha de aprendizado)
...
└── [nome-do-tema]/
    ...
    ├── default.css      # Regras adicionais de CSS personalizadas (opcional)
...
A camada de tema fica acima do pacote compilado de Tailwind/SCSS: o navegador carrega `colors.css` após a folha de estilo principal, de modo que as alterações no tema entram em vigor imediatamente, sem a necessidade de uma etapa de compilação.