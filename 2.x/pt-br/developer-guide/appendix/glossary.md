...
Termos focados em desenvolvimento usados ao longo deste guia.
...
| **Doctrine ORM** | O mapeador objeto-relacional PHP usado pelo Chamilo. Mapeia classes de entidade PHP para tabelas de banco de dados. |
...
| **PrimeVue** | A biblioteca de componentes de interface do usuário Vue 3 usada pelo Chamilo. Fornece botões, tabelas, diálogos, etc. |
...
| **Webpack** | O empacotador de módulos JavaScript que compila componentes Vue, SCSS e TypeScript em pacotes prontos para o navegador. |