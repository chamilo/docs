...
6. **Envie** para seu fork: `git push origin feature/my-feature`
7. **Crie um pull request** direcionado à branch `master`
...
As solicitações de pull são revisadas pela equipe de mantenedores. Esteja preparado para:
