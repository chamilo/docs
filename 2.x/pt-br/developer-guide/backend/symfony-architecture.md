...
* **Entidades de conteúdo** — 101 entidades para documentos, exercícios, caminhos de aprendizagem, fóruns, glossários, pesquisas, frequência, blogs, tarefas e mais
...
* **Hash de senha** — Suporta bcrypt (padrão), com migração de SHA1 e MD5 legados
...
* **Papéis sensíveis ao contexto** — Papéis no nível do curso (ROLE_CURRENT_COURSE_TEACHER, ROLE_CURRENT_COURSE_STUDENT) são computados por solicitação com base na matrícula
