...
* **[Gerador de Exercícios](exercise-generator.md)** — Gera automaticamente questões de teste a partir do conteúdo do curso ou de uma descrição de tópico
* **[Gerador de Roteiro de Aprendizagem](learning-path-generator.md)** — Cria sequências estruturadas de aprendizagem a partir de um tópico ou conjunto de objetivos
...
* O **Gerador de Roteiro de Aprendizagem** aparece ao criar roteiros de aprendizagem
