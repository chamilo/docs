...
A ferramenta de exercícios (também chamada de "testes") permite criar questionários e exames com correção automática. O Chamilo suporta uma ampla variedade de tipos de perguntas, desde escolha múltipla simples até perguntas interativas de ponto de destaque.
...
| **Propagar pontuação negativa** | Definir se pontos negativos em perguntas individuais reduzem a pontuação total abaixo de zero |

### Feedback

| Configuração | Opções |
|--------------|--------|
| **Ao final** | Mostrar resultados e respostas corretas após o aluno enviar o exercício |
...
* **Ponto de destaque** — O aluno clica em áreas específicas de uma imagem para responder
* **Delimitação de ponto de destaque** — O aluno desenha contornos ao redor de áreas em uma imagem
...
* **Anotação** — O professor faz o upload de uma imagem e o aluno a anota
...
Perguntas podem ser reutilizadas em diferentes exercícios dentro do mesmo curso. Ao adicionar uma pergunta, você pode optar por criar uma nova ou selecionar uma pergunta existente no banco de perguntas.
...
Para importar, procure pela opção **Importar** na ferramenta de exercícios e faça o upload do seu arquivo.

## Dicas

* **Misture tipos de perguntas** — Combine múltipla escolha, preencher lacunas e perguntas abertas para uma avaliação abrangente
* **Use categorias** — Organize perguntas por tópico para permitir seleção aleatória direcionada
...
* **Use feedback imediato para prática** — Crie exercícios de prática sem pontuação com feedback imediato para ajudar os alunos a aprenderem com seus erros
