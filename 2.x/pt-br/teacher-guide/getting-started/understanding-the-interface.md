...
![A barra superior com elementos anotados incluindo logotipo, caixa de entrada, tíquete de suporte e avatar do usuário](../../.gitbook/assets/top-bar-annotated.png)
...
* **Ícone de tíquete de suporte** <img src="../../.gitbook/assets/icons/mdi-ticket-account.svg" alt="Suporte" data-size="line"> — Se habilitado pelo administrador, isso dá acesso ao sistema de tíquetes de suporte.
* **Seu avatar** — Uma imagem circular no canto superior direito. Clique nela para abrir um menu suspenso com links para seu perfil, configurações de conta e sair.
...
Na parte inferior da barra lateral, você encontrará uma opção de **Sair** para encerrar rapidamente a sessão quando terminar. Essa opção também está disponível no menu suspenso do ícone do seu avatar no canto superior direito.
...
A área central da tela exibe o conteúdo da página atual. No topo, você frequentemente verá um **caminho de navegação** (breadcrumb trail) mostrando sua localização atual na plataforma (por exemplo: Início > Música Rock > Documentos). Use os breadcrumbs para voltar a uma página anterior.
...
Isso ainda é experimental e não está completamente finalizado no Chamilo 2.0, mas estamos tentando seguir as seguintes regras para todos os botões e ícones de ação na interface:
...
* **Laranja** para ações de edição. Isso inclui editar, mover, configurar, habilitar/desabilitar, ocultar e exibir.
...
* As tabelas se tornam roláveis horizontalmente
