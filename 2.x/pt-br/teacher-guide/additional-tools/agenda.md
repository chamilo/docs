...
* **Defina prazos** — Crie eventos para datas de entrega de tarefas e prazos de exercícios para que os alunos possam vê-los em seu calendário
* **Use lembretes** — Ative lembretes por e-mail para eventos importantes para ajudar os alunos a se manterem no caminho certo
* **Coordene com sessões** — Se você leciona em várias sessões, cada sessão tem seus próprios eventos, visíveis apenas para os alunos dessa sessão. Os professores têm um recurso para ver os eventos (tarefas, excursões, etc.) de outros cursos em suas sessões para evitar sobrecarregar os alunos.