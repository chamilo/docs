...
Selecione vários cursos na lista para realizar ações em lote, como excluí-los. Para exportar um curso, entre no curso e use a ferramenta **Manutenção** — não há ação de exportação em lote na lista de cursos do administrador.

## Configurações de Visibilidade do Curso

Os administradores podem sobrescrever a visibilidade definida pelos professores:
