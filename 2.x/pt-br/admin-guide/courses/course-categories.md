...
3. Insira:
   ...
   * **Permitir adicionar cursos nesta categoria?** — Define se permite que cursos sejam associados a esta categoria ou se ela serve apenas como um nível intermediário em uma hierarquia
...
O Chamilo cria 3 categorias por padrão: *Habilidades de idioma*, *Habilidades em PC* e *Projetos*. Elas podem ser renomeadas, removidas ou mantidas, dependendo das suas necessidades.
...
* **Editar** — Alterar o nome, código ou categoria pai da categoria
* **Mover** — Alterar a posição de uma categoria na lista
* **Excluir** — Remover uma categoria. Os cursos de uma categoria excluída são movidos para "sem categoria".
