...
Esses recursos estão localizados dentro do curso, na ferramenta **Manutenção**, encontrada sob o ícone de engrenagem no topo da página inicial do curso.
...
O Chamilo suporta o padrão **IMS Common Cartridge 1.3** (IMS CC 1.3) para interoperabilidade com outros sistemas de gerenciamento de aprendizagem. Você pode:
...
O recurso de reciclagem de curso permite que você mantenha a estrutura do curso, mas apague seu conteúdo.
