...
Desabilitar um plugin não exclui seus dados. Se você o habilitar novamente mais tarde, os dados ainda estarão disponíveis.

## Dicas

* **Ative apenas o que for necessário** — Cada plugin ativo adiciona uma sobrecarga. Mantenha os plugins não utilizados desativados.
* **Teste antes da produção** — Ative novos plugins primeiro em um ambiente de teste
* **Verifique a compatibilidade** — Após atualizar o Chamilo, confirme se todos os plugins ativos ainda funcionam corretamente