...
| **Windows** | Possível, mas não amplamente testado. Use WSL2 para desenvolvimento. |
...
* **Use armazenamento SSD** -- Aplicações com uso intensivo de banco de dados, como o Chamilo, se beneficiam significativamente de I/O de disco rápido.