...
Use uma Senha de Aplicativo, não sua senha regular do Gmail. Isso é adequado apenas para pequenas plataformas ou desenvolvimento, pois o Gmail possui limites de envio.
...
4. Revise o log do Chamilo em `var/log/prod.log` para erros de envio.
...
* **Use um serviço de e-mail dedicado** (SES, Mailjet, Brevo) para plataformas de produção. O SMTP direto para o seu próprio servidor de e-mail exige configuração cuidadosa para evitar problemas de entrega.
