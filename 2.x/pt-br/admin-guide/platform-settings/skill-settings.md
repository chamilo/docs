...
Comportamento do sistema de **Habilidades** — árvore de habilidades, regras de concessão, integração com o perfil.

Acesse essas configurações em **Administração > Configurações de configuração > Habilidades**. Esta categoria contém **13 configurações**, listadas abaixo com o título e o comentário fornecidos nos arquivos de configurações da plataforma (`SettingsCurrentFixtures.php`).
