...
Se não estiver vazio, o processo de criação de curso procurará alguns campos no perfil do usuário e os preencherá automaticamente para o curso. Por exemplo, um professor especializado em marketing digital poderia definir automaticamente uma marca de « marketing digital » em cada curso que ele criar.

### `course_hide_tools`

**Ocultar ferramentas dos professores**

Marque as ferramentas que você deseja ocultar dos professores. Isso proibirá o acesso à ferramenta.
...
Quando o recurso 'Validação de cursos' está ativado, um professor não pode criar um curso sozinho. Ele/ela preenche uma solicitação de curso. O administrador da plataforma revisa a solicitação e a aprova ou rejeita.<br />Este recurso depende de mensagens de e-mail automatizadas; configure o Chamilo para acessar um servidor de e-mail e usar uma conta de e-mail dedicada.
...
Esta é a URL do documento de 'Termos e Condições' que é válido para fazer uma solicitação de curso. Se o endereço for definido aqui, o usuário deve ler e concordar com esses termos e condições antes de enviar uma solicitação de curso.<br />Se você ativar o módulo 'Termos e Condições' do Chamilo e quiser que sua URL seja usada, deixe esta configuração vazia.
...
**Ativar introdução de ferramenta**
...
O recurso de avaliação de curso aparece por padrão em diferentes lugares. Se você não o desejar, ative esta opção.
...
Quando em telas onde o menu esquerdo está visível, não exibir a seção « Cursos ».
...
Permite que professores filtrem os usuários com base em campos extras na página de inscrição de usuários em seus cursos.
...
**Habilitar visualização do aluno**

Habilita a visualização do aluno, que permite que um professor ou administrador veja um curso como um aluno o veria.
