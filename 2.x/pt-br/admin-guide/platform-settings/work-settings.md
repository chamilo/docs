...
Acesse essas configurações em **Administração > Configurações de configuração > Tarefas (Trabalhos)**. Esta categoria contém **12 configurações**, listadas abaixo com o título e comentário fornecidos nos arquivos de configurações da plataforma (`SettingsCurrentFixtures.php`).
...
**Habilitar página Minhas tarefas**
...
**Redirecionar para a página inicial da ferramenta de tarefas após upload ou comentário**
...
**Impedir uploads duplicados em tarefas**

[inferido] Impede que os alunos façam upload de arquivos idênticos para a mesma submissão de tarefa.
...
**Habilitar esforço de tempo para tarefas**
...
**Forçar download do documento antes do upload da tarefa**
