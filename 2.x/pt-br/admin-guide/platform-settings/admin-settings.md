...
O primeiro nome do Administrador da Plataforma (aparece no rodapé à esquerda)
...
Habilite esta opção para permitir múltiplos usuários do sistema para usuários anônimos. Isso é útil ao usar esta plataforma como uma vitrine pública para alguns cursos. Ter múltiplos usuários anônimos permitirá o rastreamento durante a experiência de vários usuários sem misturar seus dados (o que poderia confundi-los).
...
O comportamento padrão é enviar administradores diretamente para o painel de administração (enquanto professores e alunos são enviados para a lista de cursos ou a página inicial da plataforma). Habilite para redirecionar o administrador também para sua lista de cursos.
...
**Ocultar papel de usuários normais**
...
**Definir quais papéis são ocultos para usuários normais**

Os papéis definidos como 'true' aparecerão apenas para administradores. Outros usuários não poderão vê-los.