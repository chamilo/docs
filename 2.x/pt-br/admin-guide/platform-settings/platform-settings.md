...
Se ativada, esta opção exibe um banner no topo da plataforma que solicita aos usuários que reconheçam que a plataforma utiliza cookies necessários para proporcionar a experiência do usuário. O banner pode ser facilmente reconhecido e ocultado pelo usuário. Isso permite que o Chamilo cumpra as regulamentações de cookies da UE.
...
Quando ativada, esta opção desabilita, na medida do possível, os mecanismos de copiar e colar. Útil em configurações de exames restritivos.
...
Número máximo de contas permitidas para compartilhar o mesmo endereço de e-mail. Defina como 0 para desativar esse limite.
...
Número máximo de cursos que um professor/treinador pode criar. Defina como 0 para desativar o limite. Pode ser substituído por usuário por meio da compra de um serviço BuyCourses.
...
Representa a resolução dos arquivos PDF gerados (em pontos por polegada, ou dpi). O padrão é 96. Aumentar esse valor resultará em arquivos PDF de melhor resolução, mas também aumentará o tamanho e o tempo de geração dos arquivos.
...
Incremento mínimo de tempo (em minutos) ao selecionar uma data e horário com o widget de seletor de horário. Por exemplo, pode não ser útil ter incrementos menores que 5 ou 15 minutos ao falar sobre envio de tarefas, disponibilidade de um teste, horário de início de uma sessão, etc.
