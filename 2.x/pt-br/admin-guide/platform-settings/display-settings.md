...
Mostra um link para voltar na hierarquia de cursos. Um link está disponível no final da lista de qualquer forma.
...
Marque as entradas que você deseja que apareçam no menu principal.
...
Defina as opções que você deseja que apareçam na navegação ao redor de uma tabela para mostrar menos ou mais linhas em uma página. Por exemplo, [50, 100, 200, 500].
