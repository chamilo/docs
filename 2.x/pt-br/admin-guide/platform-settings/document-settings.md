...
Quando esta funcionalidade é ativada em uma configuração multi-URL, você pode acessar a URL principal e fornecer versões específicas de qualquer arquivo (na ferramenta de documentos) para cada URL. O arquivo original será substituído pela alternativa ao visualizá-lo a partir de uma URL diferente. Isso permite personalizar ainda mais cada URL, enquanto aproveita a vantagem de reutilizar os mesmos cursos várias vezes.
...
Qual é o espaço padrão em disco rígido disponível para a ferramenta de documentos de grupos?
...
A ferramenta de documentos pode integrar links para arquivos na nuvem. A lista de serviços de nuvem é limitada a uma lista codificada, mas você pode definir o array ‘links’ que conterá uma lista de seus próprios serviços/URLs. A lista definida aqui substituirá a lista padrão.
...
Quando ativado, os administradores podem definir permissões de acesso e compartilhamento de documentos para grupos de documentos por categoria.
...
Ao ativar esta opção, você pode fazer upload de uma imagem ou texto que será automaticamente adicionado como marca d'água em todas as exportações de documentos em PDF no sistema.
...
Este texto será adicionado como marca d'água nas exportações de documentos em PDF.
...
Pastas de arquivos multimídia contendo arquivos fornecidos por padrão, organizados em categorias de vídeo, áudio, imagem e animações em flash para uso em seus cursos. Embora você possa torná-las invisíveis na ferramenta de documentos, ainda é possível utilizar esses recursos no editor web da plataforma.
...
**Permitir que alunos exportem documentos web para o formato PDF nas ferramentas de documentos e wiki**
...
**Permitir que usuários copiem arquivos de um curso para sua área de arquivos pessoais**
