...
Acesse essas configurações em **Administração > Configurações de configuração > Perfil do Usuário**. Esta categoria contém **29 configurações**, listadas abaixo com o título e o comentário fornecidos nos arquivos de configurações padrão da plataforma (`SettingsCurrentFixtures.php`).
...
**Preencher o e-mail com informações do usuário e do curso no contato do rodapé**
...
**Número padrão de itens por página no meuEspaço**

Número de registros exibidos por página nas seções de rastreamento do meuEspaço (usuários, estatísticas de trabalho, lista de alunos).
