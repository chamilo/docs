...
Acesse essas configurações em **Administração > Configurações de configuração > Sessões**. Esta categoria contém **68 configurações**, listadas abaixo com o título e comentário fornecidos nos arquivos de configurações da plataforma (`SettingsCurrentFixtures.php`).
...
Diagramas de carreira permitem exibir diagramas de carreiras, habilidades e cursos.
...
Inclui um link de redefinição de senha nos e-mails de confirmação de inscrição enviados aos usuários quando eles são matriculados em uma sessão.
...
Inclui o nome de usuário do usuário nos e-mails de confirmação de inscrição enviados quando eles são matriculados em uma sessão.
...
**Administradores de sessão não têm acesso à lista de usuários**
...
**Ordenação manual de cursos em sessão**

Ative esta opção para permitir que os administradores de sessão ordenem manualmente os cursos dentro de uma sessão. Se desativado, os cursos são ordenados alfabeticamente pelo título.
...
**Preencher campos de sessão com dados do usuário**

Array de relações entre campos extras do usuário e campos extras da sessão, para que a sessão possa ser preenchida previamente com dados correspondentes aos do usuário.
...
Mostra o comentário dos dados da sessão.
