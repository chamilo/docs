...
O comportamento padrão no Chamilo é ocultar as folhas de presença em vez de excluí-las, apenas para o caso de o professor fazê-lo por engano. Habilite esta opção para permitir que os professores *realmente* excluam folhas de presença.
...
**Habilitar Avaliação de Presença Multinível**
