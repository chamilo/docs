...
Alternativas de fluxos de trabalho transversais — criação de cursos, validação de matrículas, fluxos de tarefas e similares.
...
**Permitir Matrícula de Usuários por Administrador de Curso**

Ativar esta opção permitirá que o administrador do curso matricule usuários dentro de um curso.
...
Ative esta funcionalidade para permitir que professores atualizem manualmente o tempo gasto no curso pelos alunos.

*Padrão: `false`*

### `course_visibility_change_only_admin`

**Alterações de visibilidade de curso apenas para administradores**
...
Evite ser muito pessoal com os usuários utilizando uma conta 'bot' para enviar e-mails aos usuários quando suas contas forem desativadas por algum motivo.

*Padrão: `0`*

### `disabled_edit_session_coaches_course_editing_course`

**Desativar a capacidade de editar treinadores de curso**
...
**GRH pode acessar todos os alunos nas páginas de relatórios**

[inferido] Conceder aos gerentes de GRH/DRH acesso às páginas de relatórios de todos os alunos na plataforma.
...
**Redirecionar index.php para a URL fornecida para usuários autenticados**

Se você não deseja usar a página inicial (anúncios, cursos populares, etc.), pode definir aqui o script (a partir da raiz do documento) para onde os usuários serão redirecionados ao tentar carregar o índice.
...
**Desativar a desinscrição de usuários de cursos/sessões ao remover usuário de grupo/classe**

[inferido] Ao remover um usuário de um grupo/classe, não desinscrevê-lo automaticamente dos cursos ou sessões associados.
...
[inferido] Quando um curso é removido de um grupo/classe, não desinscrever automaticamente os usuários desse curso.
...
[inferido] Quando uma sessão é removida de um grupo/classe, não desinscrever automaticamente os usuários dessa sessão.
