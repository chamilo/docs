...
Usar bandeiras de países para representar idiomas. Esta opção não está habilitada por padrão porque alguns idiomas não estão estritamente ligados a um país, o que pode causar frustração para alguns usuários.
...
Habilitar modelos de documentos (no nível da plataforma ou do curso) para serem configurados para idiomas específicos.
