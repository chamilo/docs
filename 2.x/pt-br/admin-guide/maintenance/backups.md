...
Backups regulares são essenciais para proteger os dados do Chamilo. Esta página aborda o que deve ser feito backup e como realizá-lo.

## O que fazer backup

### 1. Banco de dados

O banco de dados do Chamilo contém todos os dados da plataforma: usuários, cursos, rastreamento, notas, mensagens e configurações. Este é o componente mais crítico para backup.
...
O Chamilo armazena arquivos enviados (documentos, imagens, pacotes SCORM) no sistema de arquivos. Os diretórios principais para backup são:
...
* **Documente seu processo** — Mantenha instruções escritas para o processo de restauração, para que qualquer pessoa da equipe possa realizá-lo