...
Turmas no Chamilo são grupos predefinidos de usuários que podem ser inscritos em sessões como uma unidade. Elas simplificam o processo de inscrição quando você treina regularmente os mesmos grupos de pessoas.

> Turmas e [Grupos de Usuários](../../admin-guide/users/user-groups.md) compartilham a mesma interface. A única diferença é a configuração de **tipo de grupo**: escolha "Turma" ao criar o grupo. Todo o resto — gerenciamento de membros, visibilidade e a própria interface — funciona de forma idêntica.
...
4. Adicione **membros** — pesquise e selecione usuários
5. Salve
