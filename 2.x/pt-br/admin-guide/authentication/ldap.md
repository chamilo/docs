...
**Vinculação por busca** — pesquisa o diretório com uma conta de serviço primeiro, depois realiza a vinculação como o usuário encontrado:
...
* **Conta de serviço** — a conta de vinculação por busca precisa apenas de acesso de leitura às entradas de usuário.
