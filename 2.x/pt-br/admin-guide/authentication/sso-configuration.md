...
* **Incompatibilidade de URI de redirecionamento** — A URI registrada no seu provedor de identidade deve corresponder exatamente a `https://your-chamilo-url/connect/<provider>/check`.
...
* **Logs** — Revise os logs em `var/log/` e os logs do seu provedor de identidade para mensagens de erro específicas.
