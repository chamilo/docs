...
A autenticação OAuth2 é configurada no arquivo `config/authentication.yaml`. O Chamilo inclui suporte integrado para Azure AD, Keycloak, Facebook e qualquer provedor genérico compatível com OAuth2.
...
Habilite o provedor e forneça suas credenciais. Todos os provedores compartilham estas chaves comuns:
...
| `force_as_login_method` | Desabilita outros métodos e força este |
...
Saia do Chamilo. O botão do provedor configurado deve aparecer na página de login. Teste com uma conta dedicada antes de implementá-lo para todos os usuários.
