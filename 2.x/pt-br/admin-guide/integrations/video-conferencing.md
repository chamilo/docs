...
**BigBlueButton** (BBB) é um sistema de conferência web de código aberto projetado para aprendizado online. É a solução de videoconferência mais comumente usada com o Chamilo.
...
3. Habilite a integração com o Zoom
