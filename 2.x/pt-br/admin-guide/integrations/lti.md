...
**LTI** (Learning Tools Interoperability - Interoperabilidade de Ferramentas de Aprendizagem) é um padrão que permite a incorporação de ferramentas de aprendizagem externas no Chamilo. A versão 1.3 é a mais recente e segura do padrão.
...
* **Verifique a compatibilidade da ferramenta** — Certifique-se de que a ferramenta externa suporta LTI 1.3 (não apenas versões mais antigas)
