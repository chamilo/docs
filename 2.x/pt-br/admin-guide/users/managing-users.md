...
Para evitar isso, verifique os detalhes do usuário, exclua cada um de seus cursos individualmente e, em seguida, exclua o usuário.
...
| **Entrar como** | Faz login na plataforma como esse usuário (personificação). Útil para solução de problemas. |
