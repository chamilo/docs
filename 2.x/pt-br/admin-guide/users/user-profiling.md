...
![A lista de campos de perfil extras mostrando campos personalizados com nome, tipo e configurações de visibilidade](../../.gitbook/assets/admin-extra-fields-list.png)
...
3. Configure o campo:
   ...
   * **Ordem** — Se você deseja gerenciar a ordem de exibição dos campos, será necessário atribuir uma ordem numérica a cada campo
